...
function Search({search, setSearch}) {
  ...
  return (
    <div className='max-w-[1100px] bg-[#1a1a1a] flex items-center rounded-full overflow-hidden border-2 border-[#333333] p-1.5 px-5 pr-8'>
        ...
        <div className='flex items-center divide-dotted divide-x-2 divide-[#333333] ml-auto'>
            <div className='flex space-x-2 pr-5'>
                ...
                <button className='tag'>Skull</button>
            </div>
